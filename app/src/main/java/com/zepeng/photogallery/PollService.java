...
public class PollService extends IntentService {
    ...
    public static final String PERM_PRIVATE = "com.zepeng.photogallery.PRIVATE";
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        String nowResultId = items.get(0).getId();
        if(nowResultId == lastResultId){
            Log.i(TAG, "Got an old result: "+nowResultId);
        }else {
            Log.i(TAG, "Got an new result: "+nowResultId);
...
//            sendBroadcast(new Intent(ACTION_SHOW_NOTIFICATION),PERM_PRIVATE);
        ...
        QueryPreferences.setLastResultId(this,nowResultId);
